# get_sanitizer_flags(VAR): compute the flags needed to enable sanitizers
# and sets them to the output variable ${VAR}. Flags are computed according
# to the value of the global variable ZIP_USE_SANITIZER.
...
function(get_sanitizer_flags VAR)
  ...
  elseif (ZIP_USE_SANITIZER STREQUAL "Address;Undefined" OR
          ZIP_USE_SANITIZER STREQUAL "Undefined;Address")
    list(APPEND SANITIZER_FLAGS "-fsanitize=address,undefined")
  else()
    message(FATAL_ERROR "Unsupported value of ZIP_USE_SANITIZER: ${ZIP_USE_SANITIZER}")
  endif()
  set(${VAR} ${SANITIZER_FLAGS} PARENT_SCOPE)
endfunction()
